"""
Chatterbox Nano TTS backend implementation.
...
CHATTERBOX_NANO_HF_REPO = "ResembleAI/chatterbox-nano"
...
class ChatterboxNanoTTSBackend:
    """Chatterbox Nano TTS backend — lightweight, English-only, with paralinguistic tags."""
    ...
    def _get_model_path(self, model_size: str = "default") -> str:
        return CHATTERBOX_NANO_HF_REPO

    def _is_model_cached(self, model_size: str = "default") -> bool:
        return is_model_cached(CHATTERBOX_NANO_HF_REPO, required_files=_NANO_WEIGHT_FILES)

    async def load_model(self, model_size: str = "default") -> None:
        """Load the Chatterbox Nano model."""
    ...
    def _load_model_sync(self):
        ...
        with model_load_progress(model_name, is_cached):
            ...
            local_path = snapshot_download(
                repo_id=CHATTERBOX_NANO_HF_REPO,
                token=None,
            ...
            if device == "cpu":
                ...
                with ChatterboxNanoTTSBackend._load_lock:
                    torch.load = _patched_load
                    try:
                        model = ChatterboxTurboTTS.from_local(local_path, device, nano=True)
                    finally:
        ...
        logger.info("Chatterbox Nano TTS loaded successfully")
    ...
    def unload_model(self) -> None:
        ...
        if self.model is not None:
            ...
            logger.info("Chatterbox Nano unloaded")
    ...
    async def generate(
        ...
        """
        Generate audio using Chatterbox Nano TTS.
        ...
        def _generate_sync():
            ...
            logger.info("[Chatterbox Nano] Generating (English)")
